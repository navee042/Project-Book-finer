...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.b1.clicked.connect(self.findprice)         #calling the function
        ...
        self.b2.clicked.connect(self.findtotal)    #calling the function
